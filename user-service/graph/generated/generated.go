...
type ComplexityRoot struct {
	Mutation struct {
		CreateUser func(childComplexity int, username string, email string, role string, password string) int
		DeleteUser func(childComplexity int, userID string) int
		Login      func(childComplexity int, email string, password string) int
		Logout     func(childComplexity int) int
		UpdateUser func(childComplexity int, userID string, username *string, email *string, role *string, password *string) int
	}

	Query struct {
		FetchUsers  func(childComplexity int) int
...
type MutationResolver interface {
	CreateUser(ctx context.Context, username string, email string, role string, password string) (*model.User, error)
	UpdateUser(ctx context.Context, userID string, username *string, email *string, role *string, password *string) (*model.User, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createUser":
		...
		return e.complexity.Mutation.CreateUser(childComplexity, args["username"].(string), args["email"].(string), args["role"].(string), args["password"].(string)), true
	...
	case "Mutation.updateUser":
		...
		return e.complexity.Mutation.UpdateUser(childComplexity, args["userId"].(string), args["username"].(*string), args["email"].(*string), args["role"].(*string), args["password"].(*string)), true
	...
	case "Query.fetchUsers":
		...
		return e.complexity.Query.FetchUsers(childComplexity), true
...
type Mutation {
  ...
  updateUser(userId: ID!, username: String, email: String, role: String, password: String): User
...
func (ec *executionContext) field_Mutation_updateUser_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["email"] = arg2
	arg3, err := graphql.ProcessArgField(ctx, rawArgs, "role", ec.unmarshalOString2ᚖstring)
	if err != nil {
		return nil, err
	}
	args["role"] = arg3
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Mutation().CreateUser(rctx, fc.Args["username"].(string), fc.Args["email"].(string), fc.Args["role"].(string), fc.Args["password"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateUser(rctx, fc.Args["userId"].(string), fc.Args["username"].(*string), fc.Args["email"].(*string), fc.Args["role"].(*string), fc.Args["password"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚖuserᚑserviceᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_fetchUsers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖuserᚑserviceᚋgraphᚋmodelᚐUserᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_fetchUsers(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) marshalNUser2userᚑserviceᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚕᚖuserᚑserviceᚋgraphᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖuserᚑserviceᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖuserᚑserviceᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖuserᚑserviceᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
